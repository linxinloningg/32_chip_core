...
{
	S1216F8BD_baudrate *cfg_prt=(S1216F8BD_baudrate *)USART3_TX_BUF;
	...
	delay_ms(200);				//等待发送完成 
	USART3_Init(BAUD_id[baud_id]);	//重新初始化串口2  
...
{
	u32 temp=width;
	S1216F8BD_pps_width *cfg_tp=(S1216F8BD_pps_width *)USART3_TX_BUF;
...
//发送一批数据给S1216F8BDF8-BD，这里通过串口3发送
//dbuf：数据缓存首地址
//len：要发送的字节数
