...
#include "usart.h"
								  ...
								  //1572864+25=
//字库区域占用的总扇区数大小(2个字库+unigbk表+字库信息=3238700字节,约占791个W25QXX扇区)
#define FONTSECSIZE	 	385
//字库存放起始地址 
#define FONTINFOADDR 	1024*1024*6 					//字库是从6M地址以后开始存放
														//前面6M被fatfs占用了.
...
//字库存放在磁盘中的路径
u8*const GBK16_PATH="/EMWINFONT/FONT/GBK16.FON";		//GBK16的存放位置
u8*const GBK12_PATH="/EMWINFONT/FONT/GBK12.FON";		//GBK12的存放位置
u8*const UNIGBK_PATH="/EMWINFONT/FONT/UNIGBK.BIN";		//UNIGBK.BIN的存放位置
